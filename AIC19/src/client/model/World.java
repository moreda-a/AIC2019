...
public interface World {
	...
	/**
	 * Returns the hero with given id. Returns null in case it doesn't exist.
	 *
	 * @param id Id of hero
	 * @return
	 */
	...
	/**
	 * If one of our heroes is in this specific cell the method returns that hero,
	 * if none of our heroes are in this cell the method returns null.
	 *
	...
	/**
	 * If one of enemy heroes is in this specific cell the method returns that hero,
	 * if none of enemy heroes are in this cell the method returns null.
	 *
	 * @param cell Specific cell we want to get the hero of
	 * @return
	 */
	...
	/**
	 * Cast one of this hero's abilities. It can only be used in ACTION phase
	 ...
	 * @param targetCellColumn Column number of the cell we want to cast the ability
	 *                         to
	 */
	...
	/**
	 * Moves the hero in the given direction. It can only be used in MOVE phase
	 * otherwise it won't do anything.
	 *
	 * @param heroId    Id of hero
	 * @param direction The direction we want the hero to move, it has one of UP,
	 *                  DOWN, LEFT or RIGHT values.
	 */
	...
	/**
	 * Picks one of the heroes in the game for you. It can only be used in PICK
	 * phase otherwise it won't do anything.
	 *
	...
	/**
	 * Returns an array of directions to reach the end cell from start cell. In case
	 * of start cell and end cell being the same cells, return empty array. If there
	 * is no path, return empty array.
	 *
	...
	/**
	 * Returns the Manhattan distance between two cells. It is actually the
	 * difference between row number and column number of the cells. Returns zero if
	...
	/**
	 * Returns the cell that our ability will land on. If the ability is a lobbing
	 * ability it would pass all the walls and hits the last cell in ability's
	 * range. Otherwise it may hit a wall or a target hero and land on the cell
	 * before it, or if there is no wall or hero, it would also hit the last cell in
	 * ability's range.
	 *
	 * @param abilityName Name of the ability we want to cast
	...
	/**
	 * Returns all the heroes an ability will affect, if we cast it from a specified
	 * cell to another. For OFFENSIVE or DODGE abilities it will return enemy
	 * heroes, and for DEFENSIVE abilities it will return ally heroes in cells
	 * around the ability's impact cell (If they are in ability's AOE).
	 *
	 * @param abilityName Name of the ability we want to cast
	 * @param startCell   The cell we want to cast from
	 * @param targetCell  The cell we are aiming to
